...
declare module '@google/model-viewer' {
   ...
   */
  type StaticAttributes = Partial<Pick<typeof ModelViewerElement, 'minimumRenderScale' | 'modelCacheSize'>>;

  export type ModelViewerAttributes = LoadingAttributes & ARAttributes & CameraAttributes & LightingAttributes & AnimationAttributes & StaticAttributes;
